...
namespace argeson.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductKodu,ProductDescription,ProductPicture,ProductPrice,CategoryId")] Products products, IFormFile ImageUpload)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,ProductKodu,ProductDescription,ProductPicture,ProductPrice,CategoryId")] Products products,IFormFile ImageUpload)
        {
